...
func newShareLinks(rootSDK *Wistia, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *ShareLinks {
	return &ShareLinks{
		rootSDK:          rootSDK,
...
func (s *ShareLinks) Get(ctx context.Context, request operations.GetMediasMediaIDShareLinkRequest, opts ...operations.Option) (*operations.GetMediasMediaIDShareLinkResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/medias/{mediaId}/share_link", request, nil)
	if err != nil {
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "get_/medias/{mediaId}/share_link",
		OAuth2Scopes:     nil,
	...
	res := &operations.GetMediasMediaIDShareLinkResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			if o.SkipDeserialization == nil || !*o.SkipDeserialization {
				...
				var out operations.GetMediasMediaIDShareLinkResponseBody
...
func (s *ShareLinks) Update(ctx context.Context, request operations.PutMediasMediaIDShareLinkRequest, opts ...operations.Option) (*operations.PutMediasMediaIDShareLinkResponse, error) {
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "put_/medias/{mediaId}/share_link",
		OAuth2Scopes:     nil,
		SecuritySource:   s.sdkConfiguration.Security,
	}
	...
	res := &operations.PutMediasMediaIDShareLinkResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			if o.SkipDeserialization == nil || !*o.SkipDeserialization {
				...
				var out operations.PutMediasMediaIDShareLinkResponseBody
				if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
					return nil, err
				}
...
func (s *ShareLinks) Delete(ctx context.Context, request operations.DeleteMediasMediaIDShareLinkRequest, opts ...operations.Option) (*operations.DeleteMediasMediaIDShareLinkResponse, error) {
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "delete_/medias/{mediaId}/share_link",
		OAuth2Scopes:     nil,
		SecuritySource:   s.sdkConfiguration.Security,
	}
	...
	res := &operations.DeleteMediasMediaIDShareLinkResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
