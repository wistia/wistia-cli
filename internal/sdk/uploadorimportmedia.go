...
type UploadOrImportMedia struct {
	rootSDK          *Wistia
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newUploadOrImportMedia(rootSDK *Wistia, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *UploadOrImportMedia {
	return &UploadOrImportMedia{
		rootSDK:          rootSDK,
...
func (s *UploadOrImportMedia) PostForm(ctx context.Context, request *operations.PostFormRequest, opts ...operations.Option) (*operations.PostFormResponse, error) {
...
// - Use `multipart/form-data` with a `file` parameter to upload from local system
// - Use `application/x-www-form-urlencoded` with a `url` parameter to import from web URL
func (s *UploadOrImportMedia) PostMultipart(ctx context.Context, request *operations.PostMultipartRequest, opts ...operations.Option) (*operations.PostMultipartResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
		operations.SupportedOptionSkipDeserialization,
