...
func newTrims(rootSDK *Wistia, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Trims {
	return &Trims{
		rootSDK:          rootSDK,
...
func (s *Trims) Create(ctx context.Context, request operations.PostMediasMediaHashedIDTrimsRequest, opts ...operations.Option) (*operations.PostMediasMediaHashedIDTrimsResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/medias/{mediaHashedId}/trims", request, nil)
	if err != nil {
	...
	res := &operations.PostMediasMediaHashedIDTrimsResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			if o.SkipDeserialization == nil || !*o.SkipDeserialization {
				...
				var out operations.PostMediasMediaHashedIDTrimsResponseBody
