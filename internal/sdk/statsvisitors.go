...
func newStatsVisitors(rootSDK *Wistia, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *StatsVisitors {
...
func (s *StatsVisitors) List(ctx context.Context, request *operations.GetStatsVisitorsRequest, opts ...operations.Option) (*operations.GetStatsVisitorsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/stats/visitors")
	if err != nil {
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "get_/stats/visitors",
		OAuth2Scopes:     nil,
	...
	res := &operations.GetStatsVisitorsResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			if o.SkipDeserialization == nil || !*o.SkipDeserialization {
				...
				var out []operations.GetStatsVisitorsResponseBody
...
func (s *StatsVisitors) Get(ctx context.Context, request operations.GetStatsVisitorsVisitorKeyRequest, opts ...operations.Option) (*operations.GetStatsVisitorsVisitorKeyResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/stats/visitors/{visitorKey}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.GetStatsVisitorsVisitorKeyResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			if o.SkipDeserialization == nil || !*o.SkipDeserialization {
				...
				var out operations.GetStatsVisitorsVisitorKeyResponseBody
				if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
					return nil, err
				}
