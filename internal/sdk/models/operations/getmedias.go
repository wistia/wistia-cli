...
// GetMediasCursor - If `cursor[enabled]` is set to 1 then cursor pagination is enabled and the
...
// GetMediasCode - A machine-readable identifier for the specific authorization failure.
type GetMediasCode string

const (
	GetMediasCodeUnauthorizedCredentials GetMediasCode = "unauthorized_credentials"
	GetMediasCodeAccountInactive         GetMediasCode = "account_inactive"
	GetMediasCodeUnauthorizedScope       GetMediasCode = "unauthorized_scope"
	GetMediasCodeUnauthorizedParams      GetMediasCode = "unauthorized_params"
)

func (e GetMediasCode) ToPointer() *GetMediasCode {
	return &e
}

// IsExact returns true if the value matches a known enum value, false otherwise.
func (e *GetMediasCode) IsExact() bool {
	if e != nil {
		switch *e {
...
func (g *GetMediasResponseBody) GetProtected() optionalnullable.OptionalNullable[bool] {
	if g == nil {
		return nil
	}
	return g.Protected
