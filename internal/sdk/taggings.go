...
func newTaggings(rootSDK *Wistia, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Taggings {
	return &Taggings{
		rootSDK:          rootSDK,
...
func (s *Taggings) BulkCreate(ctx context.Context, request operations.PostTaggingsBulkCreateRequest, opts ...operations.Option) (*operations.PostTaggingsBulkCreateResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/taggings/bulk_create")
	if err != nil {
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "post_/taggings/bulk_create",
		OAuth2Scopes:     nil,
	...
	res := &operations.PostTaggingsBulkCreateResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			if o.SkipDeserialization == nil || !*o.SkipDeserialization {
				...
				var out operations.PostTaggingsBulkCreateResponseBody
