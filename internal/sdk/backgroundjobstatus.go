...
func newBackgroundJobStatus(rootSDK *Wistia, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *BackgroundJobStatus {
...
func (s *BackgroundJobStatus) Get(ctx context.Context, request operations.GetBackgroundJobStatusBackgroundJobStatusIDRequest, opts ...operations.Option) (*operations.GetBackgroundJobStatusBackgroundJobStatusIDResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/background_job_status/{backgroundJobStatusId}", request, nil)
	if err != nil {
	...
	res := &operations.GetBackgroundJobStatusBackgroundJobStatusIDResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			if o.SkipDeserialization == nil || !*o.SkipDeserialization {
				...
				var out operations.GetBackgroundJobStatusBackgroundJobStatusIDResponseBody
	...
	case httpRes.StatusCode == 500:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out sdkerrors.GetBackgroundJobStatusBackgroundJobStatusIDInternalServerError
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
