...
func newStatsEvents(rootSDK *Wistia, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *StatsEvents {
	return &StatsEvents{
		rootSDK:          rootSDK,
...
func (s *StatsEvents) List(ctx context.Context, request *operations.GetStatsEventsRequest, opts ...operations.Option) (*operations.GetStatsEventsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/stats/events")
	if err != nil {
	...
	res := &operations.GetStatsEventsResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			if o.SkipDeserialization == nil || !*o.SkipDeserialization {
				...
				var out []operations.GetStatsEventsResponseBody
	...
	case httpRes.StatusCode == 401:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out sdkerrors.GetStatsEventsUnauthorizedError
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
	...
	case httpRes.StatusCode == 500:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out sdkerrors.GetStatsEventsInternalServerError
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *StatsEvents) Get(ctx context.Context, request operations.GetStatsEventsEventKeyRequest, opts ...operations.Option) (*operations.GetStatsEventsEventKeyResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/stats/events/{eventKey}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "get_/stats/events/{eventKey}",
		OAuth2Scopes:     nil,
		SecuritySource:   s.sdkConfiguration.Security,
	}
	...
	res := &operations.GetStatsEventsEventKeyResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			if o.SkipDeserialization == nil || !*o.SkipDeserialization {
				...
				var out operations.GetStatsEventsEventKeyResponseBody
				if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
					return nil, err
				}
	...
	case httpRes.StatusCode == 500:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out sdkerrors.GetStatsEventsEventKeyInternalServerError
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
