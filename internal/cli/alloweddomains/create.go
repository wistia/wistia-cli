...
var createCmdMeta = []flagutil.FlagMeta{
	{FlagName: "domain", FieldPath: "Domain", Kind: flagutil.FlagKindString, Required: true, Description: "The domain name to add (www will be automatically stripped) [required]"},
}
...
func initCreateCmd(parent *cobra.Command) error {
	...
	if err := flagutil.ValidateMeta[operations.PostAllowedDomainsRequest](createCmdMeta); err != nil {
...
func runCreateCmd(cmd *cobra.Command, args []string) error {
	...
	request, err := flagutil.BuildRequest[operations.PostAllowedDomainsRequest](cmd, createCmdMeta, "", "body")
	if err != nil {
		return err
	}
	...
	res, err := s.AllowedDomains.Create(cmd.Context(), *request, sdkOpts...)
	if err != nil {
