...
var listCmdMeta = []flagutil.FlagMeta{
	...
	{FlagName: "sort-by", FieldPath: "SortBy", Kind: flagutil.FlagKindEnum, Optional: true, HasDefault: true, DefaultStr: "id", EnumValues: []string{"id", "domain"}, Description: "Ordering. When using cursor pagination (see cursor param),\nonly `id` and `domain` are supported.\n (options: id, domain)"},
