...
func initDeleteCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Example: "  wistia webinars delete --id <id>",
		RunE:    runDeleteCmd,
	}
	flagutil.RegisterFlags(cmd, deleteCmdMeta)
	if err := flagutil.ValidateMeta[operations.DeleteWebinarsIDRequest](deleteCmdMeta); err != nil {
...
func runDeleteCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.DeleteWebinarsIDRequest](cmd, deleteCmdMeta, "", "")
	if err != nil {
		return err
	}
	...
	res, err := s.Webinars.Delete(cmd.Context(), *req, sdkOpts...)
	if err != nil {
