...
func initGetCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Example: "  wistia webinars get --id <id>",
		RunE:    runGetCmd,
	}
	flagutil.RegisterFlags(cmd, getCmdMeta)
	if err := flagutil.ValidateMeta[operations.GetWebinarsIDRequest](getCmdMeta); err != nil {
...
func runGetCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.GetWebinarsIDRequest](cmd, getCmdMeta, "", "")
	if err != nil {
		return err
	}
	...
	res, err := s.Webinars.Get(cmd.Context(), *req, sdkOpts...)
	if err != nil {
