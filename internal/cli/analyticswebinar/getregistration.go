...
var getRegistrationCmdMeta = []flagutil.FlagMeta{
...
// runGetRegistrationCmd executes the get-registration command.
func runGetRegistrationCmd(cmd *cobra.Command, args []string) error {
