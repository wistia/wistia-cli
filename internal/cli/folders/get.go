...
func initGetCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Example: "  wistia folders get --id <id>",
		RunE:    runGetCmd,
	}
	flagutil.RegisterFlags(cmd, getCmdMeta)
	if err := flagutil.ValidateMeta[operations.GetFoldersIDRequest](getCmdMeta); err != nil {
...
func runGetCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.GetFoldersIDRequest](cmd, getCmdMeta, "", "")
	if err != nil {
		return err
	}
