...
func initDeleteCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Example: "  wistia folders delete --id <id>",
		RunE:    runDeleteCmd,
	}
	flagutil.RegisterFlags(cmd, deleteCmdMeta)
	if err := flagutil.ValidateMeta[operations.DeleteFoldersIDRequest](deleteCmdMeta); err != nil {
...
func runDeleteCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.DeleteFoldersIDRequest](cmd, deleteCmdMeta, "", "")
	if err != nil {
		return err
	}
	...
	res, err := s.Folders.Delete(cmd.Context(), *req, sdkOpts...)
	if err != nil {
