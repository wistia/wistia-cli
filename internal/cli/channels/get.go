...
func initGetCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		Use:     "get",
		Short:   "Channels Show",
		Long:    "Returns the Channel associated with the hashedId.\n\n## Requires api token with one of the following permissions\n```\nRead, update & delete anything\nRead all data\nRead all folder and media data\n```",
		Example: "  wistia channels get --channel-hashed-id <id>",
		RunE:    runGetCmd,
	}
	flagutil.RegisterFlags(cmd, getCmdMeta)
	if err := flagutil.ValidateMeta[operations.GetChannelsChannelHashedIDRequest](getCmdMeta); err != nil {
...
func runGetCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.GetChannelsChannelHashedIDRequest](cmd, getCmdMeta, "", "")
	if err != nil {
		return err
	}
	...
	res, err := s.Channels.Get(cmd.Context(), *req, sdkOpts...)
	if err != nil {
