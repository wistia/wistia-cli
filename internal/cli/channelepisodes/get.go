...
var getCmdMeta = []flagutil.FlagMeta{
	...
	{FlagName: "channel-episode-id", FieldPath: "ChannelEpisodeID", Kind: flagutil.FlagKindString, Required: true, Description: "The hashed ID of the channel episode. [required]"},
}
