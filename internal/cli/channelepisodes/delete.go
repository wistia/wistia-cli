...
func initDeleteCmd(parent *cobra.Command) error {
	...
	if err := flagutil.ValidateMeta[operations.DeleteChannelEpisodesChannelEpisodeHashedIDRequest](deleteCmdMeta); err != nil {
...
func runDeleteCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.DeleteChannelEpisodesChannelEpisodeHashedIDRequest](cmd, deleteCmdMeta, "", "")
	if err != nil {
		return err
	}
