...
func initCreateCmd(parent *cobra.Command) error {
	...
	if err := flagutil.ValidateMeta[operations.PostMediasMediaHashedIDCaptionsRequest](createCmdMeta); err != nil {
...
func runCreateCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.PostMediasMediaHashedIDCaptionsRequest](cmd, createCmdMeta, "Body", "body")
	if err != nil {
		return err
	}
	...
	res, err := s.Captions.Create(cmd.Context(), *req, sdkOpts...)
	if err != nil {
