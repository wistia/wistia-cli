...
// initListAllCmd initializes the list-all command.
func initListAllCmd(parent *cobra.Command) error {
	...
	if err := flagutil.ValidateMeta[operations.GetCaptionsRequest](listAllCmdMeta); err != nil {
		return fmt.Errorf("invalid metadata for list-all: %w", err)
	}
	parent.AddCommand(cmd)
	return nil
}

// runListAllCmd executes the list-all command.
func runListAllCmd(cmd *cobra.Command, args []string) error {
