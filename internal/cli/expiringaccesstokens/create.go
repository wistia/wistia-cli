...
var createCmdMeta = []flagutil.FlagMeta{
	{FlagName: "expiring-access-token", Shorthand: "e", FieldPath: "ExpiringAccessToken", Kind: flagutil.FlagKindJSON, Optional: true, Annotations: `json:"expiring_access_token,omitempty"`, Description: "JSON object"},
}
...
func initCreateCmd(parent *cobra.Command) error {
	...
	if err := flagutil.ValidateMeta[operations.PostExpiringTokenRequest](createCmdMeta); err != nil {
...
func runCreateCmd(cmd *cobra.Command, args []string) error {
	...
	request, err := flagutil.BuildRequest[operations.PostExpiringTokenRequest](cmd, createCmdMeta, "", "body")
	if err != nil {
		return err
	}
	...
	res, err := s.ExpiringAccessTokens.Create(cmd.Context(), request, sdkOpts...)
	if err != nil {
