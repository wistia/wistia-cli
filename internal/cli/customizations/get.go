...
func initGetCmd(parent *cobra.Command) error {
	...
	if err := flagutil.ValidateMeta[operations.GetMediasMediaIDCustomizationsRequest](getCmdMeta); err != nil {
...
func runGetCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.GetMediasMediaIDCustomizationsRequest](cmd, getCmdMeta, "", "")
	if err != nil {
		return err
	}
	...
	res, err := s.Customizations.Get(cmd.Context(), *req, sdkOpts...)
	if err != nil {
