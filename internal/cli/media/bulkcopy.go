...
var bulkCopyCmdMeta = []flagutil.FlagMeta{
...
// initBulkCopyCmd initializes the bulk-copy command.
func initBulkCopyCmd(parent *cobra.Command) error {
...
// runBulkCopyCmd executes the bulk-copy command.
func runBulkCopyCmd(cmd *cobra.Command, args []string) error {
