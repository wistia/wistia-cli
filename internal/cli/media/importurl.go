...
var importURLCmdMeta = []flagutil.FlagMeta{
	{FlagName: "url", Shorthand: "u", FieldPath: "URL", Kind: flagutil.FlagKindString, Required: true, Description: "The publicly accessible URL of the media file to import. [required]"},
...
// initImportUrlCmd initializes the import-url command.
func initImportUrlCmd(parent *cobra.Command) error {
...
// runImportUrlCmd executes the import-url command.
func runImportUrlCmd(cmd *cobra.Command, args []string) error {
	...
	res, err := s.Media.ImportURL(cmd.Context(), request, sdkOpts...)
	if err != nil {
