...
var updateCmdMeta = []flagutil.FlagMeta{
	{FlagName: "project-id", Shorthand: "p", FieldPath: "ProjectID", Kind: flagutil.FlagKindString, Required: true, Description: "ID of the project [required]"},
...
func initUpdateCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		Use:     "update",
		Short:   "Project Sharing Update",
		Long:    "Update a sharing on a project.\n\n## Requires api token with one of the following permissions\n```\nRead, update & delete anything\n```",
		Example: "  wistia project-sharings update --project-id <id> --sharing-id <id>",
		RunE:    runUpdateCmd,
	}
	flagutil.RegisterFlags(cmd, updateCmdMeta)
	if err := flagutil.ValidateMeta[operations.PutProjectsProjectIDSharingsSharingIDRequest](updateCmdMeta); err != nil {
...
func runUpdateCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.PutProjectsProjectIDSharingsSharingIDRequest](cmd, updateCmdMeta, "Body", "body")
	if err != nil {
		return err
	}
	...
	res, err := s.ProjectSharings.Update(cmd.Context(), *req, sdkOpts...)
	if err != nil {
