...
func initUpdateCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Long:    "Update a subfolder's name and/or description. \n\n## Requires api token with one of the following permissions\n```\nRead, update & delete anything\n```",
		Example: "  wistia subfolders update --project-id abc123def4 --subfolder-id xyz789ghi0",
		RunE:    runUpdateCmd,
	}
	flagutil.RegisterFlags(cmd, updateCmdMeta)
	if err := flagutil.ValidateMeta[operations.PutProjectsProjectIDSubfoldersSubfolderIDRequest](updateCmdMeta); err != nil {
...
func runUpdateCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.PutProjectsProjectIDSubfoldersSubfolderIDRequest](cmd, updateCmdMeta, "Body", "body")
	if err != nil {
		return err
	}
