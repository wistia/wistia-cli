...
var bulkDeleteCmdMeta = []flagutil.FlagMeta{
...
// runBulkDeleteCmd executes the bulk-delete command.
func runBulkDeleteCmd(cmd *cobra.Command, args []string) error {
