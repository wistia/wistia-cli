...
func initCreateCmd(parent *cobra.Command) error {
	...
	if err := flagutil.ValidateMeta[operations.PostFoldersFolderIDSubfoldersRequest](createCmdMeta); err != nil {
...
func runCreateCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.PostFoldersFolderIDSubfoldersRequest](cmd, createCmdMeta, "Body", "body")
	if err != nil {
		return err
	}
