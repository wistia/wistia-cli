...
```
wistia captions list [flags]
```

### Examples

```
  wistia captions list --media-hashed-id <id>
```
...
```
  ...
  -m, --media-hashed-id string   The hashed ID of the media for which captions are to be retrieved. [required]
```
