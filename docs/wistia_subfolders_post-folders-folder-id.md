## wistia subfolders post-folders-folder-id
...
```
wistia subfolders post-folders-folder-id [flags]
```

### Examples

```
  wistia subfolders post-folders-folder-id --folder-id abc123def4 --name Marketing Videos
```
...
```
  ...
  -h, --help                 help for post-folders-folder-id
