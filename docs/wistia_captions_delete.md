...
```
wistia captions delete [flags]
```

### Examples

```
  wistia captions delete --media-hashed-id <id> --language-code <value>
```
...
```
  ...
  -l, --language-code string     Language code conforming to ISO-639-2 for which the captions should be removed. [required]
