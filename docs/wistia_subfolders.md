...
```
wistia subfolders [flags]
```

### Options

```
  -h, --help   help for subfolders
```
...
* [wistia subfolders delete-subfolder](wistia_subfolders_delete-subfolder.md)	 - Delete Subfolder
* [wistia subfolders get](wistia_subfolders_get.md)	 - Show Subfolder
* [wistia subfolders list](wistia_subfolders_list.md)	 - Subfolder List
