...
```
wistia folders put-folders-id [flags]
```

### Examples

```
  wistia folders put-folders-id --id <id>
```
...
```
      ...
      --description string       The folder’s new description.
  -h, --help                     help for put-folders-id
