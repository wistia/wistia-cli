## wistia analytics-media get-analytics-medias-media-id-timeseries
...
```
wistia analytics-media get-analytics-medias-media-id-timeseries [flags]
```

### Examples

```
  wistia analytics-media get-analytics-medias-media-id-timeseries --media-id <id> --start-date 2024-05-04 --end-date 2025-12-15 --granularity daily
```
...
```
  ...
  -h, --help                 help for get-analytics-medias-media-id-timeseries
