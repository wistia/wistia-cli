...
```
wistia allowed-domains create [flags]
```

### Examples

```
  wistia allowed-domains create --domain example.com
```
...
```
      ...
      --domain string   The domain name to add (www will be automatically stripped) [required]
