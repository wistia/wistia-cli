## wistia folder-sharings get-folders-folder-id-sharings
...
```
wistia folder-sharings get-folders-folder-id-sharings [flags]
```

### Examples

```
  wistia folder-sharings get-folders-folder-id-sharings --folder-id <id>
```
...
```
  ...
  -f, --folder-id string         Folder Hashed ID [required]
      --hashed-ids stringArray   Filter sharings by their hashed IDs
  -h, --help                     help for get-folders-folder-id-sharings
