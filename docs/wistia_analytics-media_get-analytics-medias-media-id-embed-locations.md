## wistia analytics-media get-analytics-medias-media-id-embed-locations
...
```
wistia analytics-media get-analytics-medias-media-id-embed-locations [flags]
```

### Examples

```
  wistia analytics-media get-analytics-medias-media-id-embed-locations --media-id <id> --start-date 2025-01-17 --end-date 2024-09-01
```
...
```
      ...
      --end-date string         End date for the analytics period in ISO 8601 format (YYYY-MM-DD). [required]
  -h, --help                    help for get-analytics-medias-media-id-embed-locations
  -m, --media-id string         The hashed ID of the video. [required]
  -p, --per-page int            Number of results to return (max 100). (default 10)
      --sort-by string          The metric to sort embed locations by. (options: plays, loads, engagement_rate, play_rate) (default "plays")
