...
```
wistia webinars post [flags]
```

### Examples

```
  wistia webinars post --title Wellness Session: Coping with Outie Memories --scheduled-for 2024-03-20T15:30:00-05:00 --event-duration 60
```
