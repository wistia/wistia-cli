## wistia analytics-media get-analytics-medias-media-id-languages
...
```
wistia analytics-media get-analytics-medias-media-id-languages [flags]
```

### Examples

```
  wistia analytics-media get-analytics-medias-media-id-languages --media-id <id> --start-date 2026-07-01 --end-date 2024-01-19
```
...
```
  ...
  -h, --help                help for get-analytics-medias-media-id-languages
