## wistia subfolders delete-subfolder
...
```
wistia subfolders delete-subfolder [flags]
```

### Examples

```
  wistia subfolders delete-subfolder --project-id abc123def4 --subfolder-id xyz789ghi0
```

### Options

```
  -h, --help                  help for delete-subfolder
