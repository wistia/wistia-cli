...
```
wistia project-sharings get [flags]
```

### Examples

```
  wistia project-sharings get --project-id <id> --sharing-id 495335
```
...
```
  -h, --help                help for get
  -p, --project-id string   Hashed ID for the project for which you'd like to see sharings. [required]
