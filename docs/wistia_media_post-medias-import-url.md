## wistia media post-medias-import-url
...
```
wistia media post-medias-import-url [flags]
```

### Examples

```
  wistia media post-medias-import-url --url https://example.com/video.mp4
```
...
```
  ...
  -h, --help               help for post-medias-import-url
  -u, --url string         The URL of the media file to import. [required]
```
