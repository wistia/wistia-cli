...
```
  wistia media move --hashed-ids '["<value 1>","<value 2>"]' --folder-id <id>
```
...
```
  ...
  -f, --folder-id string         The hashed ID of the folder where you want the media moved. [required]
      --hashed-ids stringArray   An array of the media hashed IDs to be moved. [required]
  -h, --help                     help for move
  -s, --subfolder-id string      Optional. The hashed ID of the subfolder where you want the media moved. If not provided, media will be moved to the folder's default subfolder. The subfolder must belong to the specified folder.
```
