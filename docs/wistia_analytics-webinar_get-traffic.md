## wistia analytics-webinar get-traffic
...
```
wistia analytics-webinar get-traffic [flags]
```

### Examples

```
  wistia analytics-webinar get-traffic --webinar-id <id> --group-by utm_campaign
```
