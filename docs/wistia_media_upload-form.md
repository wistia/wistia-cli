...
```
wistia media upload-form [flags]
```

### Examples

```
  wistia media upload-form --url http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4
```
...
```
  ...
  -u, --url string            The web location of the media file to import. [required]
```
