## wistia analytics-media get-conversions
...
```
wistia analytics-media get-conversions [flags]
```

### Examples

```
  wistia analytics-media get-conversions --media-id <id> --start-date 2024-02-20 --end-date 2026-07-17
```
...
```
  ...
  -h, --help                help for get-conversions
