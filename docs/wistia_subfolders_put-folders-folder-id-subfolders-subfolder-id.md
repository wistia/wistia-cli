## wistia subfolders put-folders-folder-id-subfolders-subfolder-id
...
```
wistia subfolders put-folders-folder-id-subfolders-subfolder-id [flags]
```

### Examples

```
  wistia subfolders put-folders-folder-id-subfolders-subfolder-id --folder-id abc123def4 --subfolder-id xyz789ghi0
```
...
```
  ...
  -h, --help                  help for put-folders-folder-id-subfolders-subfolder-id
