## wistia upload-or-import-media post-multipart
...
```
wistia upload-or-import-media post-multipart [flags]
```

### Examples

```
  wistia upload-or-import-media post-multipart --request '{"url":"http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4","low_priority":true}'
```
...
```
  ...
  -f, --file string           The media file, multipart-form encoded into the request body. [required]
  -h, --help                  help for post-multipart
