## wistia analytics-media get-traffic
...
```
wistia analytics-media get-traffic [flags]
```

### Examples

```
  wistia analytics-media get-traffic --media-id <id> --start-date 2026-11-05 --end-date 2026-08-31 --group-by utm_source
```
