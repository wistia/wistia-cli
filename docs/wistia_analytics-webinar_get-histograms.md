## wistia analytics-webinar get-histograms
...
```
wistia analytics-webinar get-histograms [flags]
```

### Examples

```
  wistia analytics-webinar get-histograms --webinar-id <id>
```

### Options

```
  -h, --help                help for get-histograms
