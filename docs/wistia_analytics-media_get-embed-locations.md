## wistia analytics-media get-embed-locations
...
```
wistia analytics-media get-embed-locations [flags]
```

### Examples

```
  wistia analytics-media get-embed-locations --media-id <id> --start-date 2025-01-17 --end-date 2024-09-01
```
...
```
  ...
  -h, --help                    help for get-embed-locations
