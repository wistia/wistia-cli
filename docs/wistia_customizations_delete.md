...
```
wistia customizations delete [flags]
```

### Examples

```
  wistia customizations delete --media-id <id>
```
...
```
  ...
  -m, --media-id string   The hashed ID of the media whose customizations are to be deleted. [required]
```
