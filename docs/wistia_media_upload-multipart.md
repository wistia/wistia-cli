...
```
wistia media upload-multipart [flags]
```

### Examples

```
  wistia media upload-multipart --request '{"url":"http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4","low_priority":true}'
```
...
```
  ...
  -h, --help                  help for upload-multipart
