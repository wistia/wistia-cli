## wistia webinar-registrations create
...
```
wistia webinar-registrations create [flags]
```

### Examples

```
  wistia webinar-registrations create --webinar-id <id> --email john.doe@example.com --first-name John --last-name Doe
```
