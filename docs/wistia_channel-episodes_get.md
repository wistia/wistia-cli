...
```
wistia channel-episodes get [flags]
```

### Examples

```
  wistia channel-episodes get --channel-hashed-id <id> --channel-episode-id <id>
```

### Options

```
      --channel-episode-id string   The hashed ID of the channel episode. [required]
