## wistia subfolders delete-folders-folder-id-subfolders-subfolder-id
...
```
wistia subfolders delete-folders-folder-id-subfolders-subfolder-id [flags]
```

### Examples

```
  wistia subfolders delete-folders-folder-id-subfolders-subfolder-id --folder-id abc123def4 --subfolder-id xyz789ghi0
```
...
```
  ...
  -h, --help                  help for delete-folders-folder-id-subfolders-subfolder-id
