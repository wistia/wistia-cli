## wistia analytics-media get-languages
...
```
wistia analytics-media get-languages [flags]
```

### Examples

```
  wistia analytics-media get-languages --media-id <id> --start-date 2026-07-01 --end-date 2024-01-19
```
