## wistia subfolders get-folders-folder-id
...
```
wistia subfolders get-folders-folder-id [flags]
```

### Examples

```
  wistia subfolders get-folders-folder-id --folder-id abc123def4
```
...
```
  ...
  -h, --help                     help for get-folders-folder-id
