## wistia analytics-webinar get-audience
...
```
wistia analytics-webinar get-audience [flags]
```

### Examples

```
  wistia analytics-webinar get-audience --webinar-id <id>
```
